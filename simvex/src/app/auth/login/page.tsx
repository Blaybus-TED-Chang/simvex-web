...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 flex items-center justify-center px-4">
      <div className="w-full max-w-[440px]" style={{ animation: 'scaleIn 0.3s ease both' }}>
        {/* 카드 */}
        <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl shadow-gray-200/50 border border-gray-100">
          {/* 상단 장식 바 */}
        ...
        <div className="text-center mt-6">
          <Link href="/" className="text-[13px] text-gray-400 hover:text-[#001AFF] transition-colors">
            홈으로 돌아가기
          </Link>
        </div>
      </div>
