...
import RobotArmControls from '@/components/robot-arm-simulator/RobotArmControls';
import RobotArmLearningPanel from '@/components/robot-arm-simulator/RobotArmLearningPanel';
import { ControlsHelp } from '@/components/ui/ControlsHelp';

const RobotArmScene = dynamic(
  () => import('@/components/robot-arm-simulator/RobotArmScene'),
  {
    ssr: false,
    loading: () => (
      <div className="w-full h-full flex items-center justify-center bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading Robot Arm...</p>
        </div>
      </div>
    ),
  },
    ...
    <>
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 min-w-0 relative">
          <RobotArmScene isDarkMode={isDarkMode} />
          <ControlsHelp show={showControls} onDismiss={() => setShowControls(false)} isDarkMode={isDarkMode} controls={CONTROLS_GUIDE} />
        </div>
        ...
        >
          <RobotArmControls isDarkMode={isDarkMode} />
        </div>
      </div>

      {/* Learning Panel */}
      <RobotArmLearningPanel isOpen={showLearning} onClose={onCloseLearning} isDarkMode={isDarkMode} />
    </>
  );
}
